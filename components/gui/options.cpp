...
OptionsDialog::OptionsDialog(const Common::String &domain, int x, int y, int w, int h)
	: Dialog(x, y, w, h), _domain(domain),  _tabWidget(0), _graphicsTabId(-1), _midiTabId(-1), _pathsTabId(-1) {
	init();
}

OptionsDialog::OptionsDialog(const Common::String &domain, const Common::String &name)
	: Dialog(name), _domain(domain), _tabWidget(0), _graphicsTabId(-1), _midiTabId(-1), _pathsTabId(-1)  {
	init();
}
