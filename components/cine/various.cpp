...
void CineEngine::quickLoad(){
	int16 selectedSave=1;

	char saveNameBuffer[256];
	//sprintf(saveNameBuffer, "%s.%1d", _targetName.c_str(), selectedSave);
	sprintf(saveNameBuffer,"quicksave.s01");
...
void CineEngine::quickSave(){
	...
	Common::strlcpy(currentSaveName[selectedSave], "quicksave.s01", 20);
	sprintf(saveFileName,"%s","quicksave.s01");
